...
!function (a) {
    ...
    function Qa(c, d) {
        ...
        function f() {
            U = O.theme ? "ui" : "fc", c.addClass("fc"), O.isRTL ? c.addClass("fc-rtl") : c.addClass("fc-ltr"), O.theme ? c.addClass("ui-widget") : c.addClass("fc-unthemed"), T = a("<div class='fc-view-container'/>").prependTo(c), R = N.header = new Ta(N, O), S = R.render(), S && c.prepend(S), i(O.defaultView), O.handleWindowResize && (Y = ja(m, O.windowResizeDelay), a(window).resize(Y))
        }
        ...
        function i(b) {
            da++, V && b && V.type !== b && (R.deactivateButton(V.type), H(), V.removeElement(), V = N.view = null), !V && b && (V = N.view = ca[b] || (ca[b] = N.instantiateView(b)), V.setElement(a("<div class='fc-view fc-" + b + "-view' />").appendTo(T)), R.activateButton(b)), V && (Z = V.massageCurrentDate(Z), V.displaying && Z.isWithin(V.intervalStart, V.intervalEnd) || h() && (V.display(Z), I(), u(), v(), q())), I(), da--
        }

        function j(a) {
            return h() ? (a && l(), da++, V.updateSize(!0), da--, !0) : void 0
        }
        ...
        function m(a) {
            !da && a.target === window && V.start && j(!0) && V.trigger("windowResize", ba)
        }
        ...
        function o(a) {
            aa(N.getEventSourcesByMatchArray(a))
        }

        function p() {
            h() && (H(), V.displayEvents(ea), I())
        }

        function q() {
            !O.lazyFetching || $(V.start, V.end) ? r() : p()
        }
        ...
        P._fullCalendar_weekCalc = function (a) {
            ...
            var a;
            return "local" === O.timezone ? (a = Wa.moment.apply(null, arguments), a.hasTime() && a.local()) : a = "UTC" === O.timezone ? Wa.moment.utc.apply(null, arguments) : Wa.moment.parseZone.apply(null, arguments), "_locale" in a ? a._locale = P : a._lang = P, a
        ...
        var R, S, T, U, V, W, Y, Z, $ = N.isFetchNeeded, _ = N.fetchEvents, aa = N.fetchEventSources, ba = c[0], ca = {}, da = 0, ea = [];
    ...
    function Ta(b, c) {
        ...
        function j(a) {
            o.find(".fc-" + a + "-button").prop("disabled", !0).addClass(n + "-state-disabled")
        }

        function k(a) {
            o.find(".fc-" + a + "-button").prop("disabled", !1).removeClass(n + "-state-disabled")
        }
    ...
    function Ua(c) {
        ...
        function f(a, b) {
            var c, d;
            for ("reset" === b ? da = [] : "add" !== b && (da = v(da, a)), c = 0; c < a.length; c++)d = a[c], "pending" !== d._status && ca++, d._fetchId = (d._fetchId || 0) + 1, d._status = "pending";
            for (c = 0; c < a.length; c++)d = a[c], g(d, d._fetchId)
        }
        ...
        function g(b, c) {
            j(b, function (d) {
                ...
                if (c === b._fetchId && "rejected" !== b._status) {
                    if (b._status = "resolved", d)for (e = 0; e < d.length; e++)f = d[e], g = h ? f : C(f, b), g && da.push.apply(da, G(g));
                    i()
                }
            })
        }
        ...
        function j(b, d) {
            var e, f, g = Wa.sourceFetchers;
            for (e = 0; e < g.length; e++) {
                if (f = g[e].call(U, b, W.clone(), X.clone(), c.timezone, d), f === !0)return;
                if ("object" == typeof f)return void j(f, d)
            }
            var h = b.events;
            if (h)a.isFunction(h) ? (U.pushLoading(), h.call(U, W.clone(), X.clone(), c.timezone, function (a) {
                d(a), U.popLoading()
            })) : a.isArray(h) ? d(h) : d(); else {
                var i = b.url;
                if (i) {
                    ...
                    p && (o[p] = W.format()), q && (o[q] = X.format()), c.timezone && "local" != c.timezone && (o[r] = c.timezone), U.pushLoading(), a.ajax(a.extend({}, Eb, b, {
                        data: o,
                        success: function (b) {
                            b = b || [];
                        ...
                        complete: function () {
                            aa(n, this, arguments), U.popLoading()
                        }
                    }))
                } else d()
            }
        ...
        function r(b) {
            b ? a.isArray(b) || (b = [b]) : b = [];
            var c, d = [];
            for (c = 0; c < b.length; c++)d.push.apply(d, s(b[c]));
            return d
        }
        ...
        function s(b) {
            ...
            return d = q(b), d ? [d] : a.grep($, function (a) {
                return t(b, a)
            })
        }
        ...
        function w(a) {
            a.start = U.moment(a.start), a.end ? a.end = U.moment(a.end) : a.end = null, H(a, x(a)), Y(da)
        }

        function x(b) {
            var c = {};
            return a.each(b, function (a, b) {
                y(a) && void 0 !== b && _(b) && (c[a] = b)
            }), c
        }
        ...
        function C(d, e) {
            var f, g, h, i = {};
            if (c.eventDataTransform && (d = c.eventDataTransform(d)), e && e.eventDataTransform && (d = e.eventDataTransform(d)), a.extend(i, d), e && (i.source = e), i._id = d._id || (void 0 === d.id ? "_fc" + Fb++ : d.id + ""), d.className ? "string" == typeof d.className ? i.className = d.className.split(/\s+/) : i.className = d.className : i.className = [], f = d.start || d.date, g = d.end, V(f) && (f = b.duration(f)), V(g) && (g = b.duration(g)), d.dow || b.isDuration(f) || b.isDuration(g))i.start = f ? b.duration(f) : null, i.end = g ? b.duration(g) : null, i._recurring = !0; else {
                if (f && (f = U.moment(f), !f.isValid()))return !1;
                g && (g = U.moment(g), g.isValid() || (g = null)), h = d.allDay, void 0 === h && (h = ba(e ? e.allDayDefault : void 0, c.allDayDefault)), D(f, g, h, i)
            }
            return U.normalizeEvent(i), i
        }
        ...
        function E(a) {
            F(a), a.end && !a.end.isAfter(a.start) && (a.end = null), a.end || (c.forceEventDuration ? a.end = U.getDefaultEventEnd(a.allDay, a.start) : a.end = null)
        }
        ...
        function H(b, c, d) {
            ...
            return c = c || {}, c.start || (c.start = b.start.clone()), void 0 === c.end && (c.end = b.end ? b.end.clone() : null), null == c.allDay && (c.allDay = b.allDay), E(c), f = {
                ...
                y(a) && void 0 !== b && (l[a] = b)
            }), k = I(B(b._id), g, c.allDay, h, j, l), {dateDelta: h, durationDelta: j, undo: k}
        }
        ...
        function J(b) {
            ...
            return e && (d = a.extend({}, f, "object" == typeof e ? e : {})), d ? (b && (d.start = null, d.end = null), G(C(d), g.start, g.end)) : []
        }
        ...
        function P(a) {
            return Q(a, c.selectConstraint, c.selectOverlap)
        }
        ...
        function R(a) {
            return "businessHours" === a ? J() : "object" == typeof a ? G(C(a)) : B(a)
        }
    ...
    var Wa = a.fullCalendar = {version: "2.8.0", internalApiVersion: 4}, Xa = Wa.views = {};
    ...
    var ub = Wa.DayTableMixin = {
        ...
        sliceRangeByDay: function (a) {
            ...
            for (b = 0; b < this.rowCnt; b++)for (c = b * h,
                                                      d = c + h - 1, e = c; d >= e; e++)f = Math.max(j, e), g = Math.min(k, e), f = Math.ceil(f), g = Math.floor(g), g >= f && l.push({
                row: b,
    ...
    var xb = Wa.View = ya.extend(lb, mb, {
        ...
        display: function (a) {
            var b = this, c = null;
            return this.displaying && (c = this.queryScroll()), this.calendar.freezeContentHeight(), ka(this.clear(), function () {
                return b.displaying = ka(b.displayView(a), function () {
                    b.forceScroll(b.computeInitialScroll(c)), b.calendar.unfreezeContentHeight(), b.triggerRender()
                })
            })
        },
        clear: function () {
        ...
        initOptions: function (a) {
            var b, e, f, g;
            a = d(a), b = a.lang, e = Ab[b], e || (b = zb.defaults.lang, e = Ab[b] || {}), f = ba(a.isRTL, e.isRTL, zb.defaults.isRTL), g = f ? zb.rtlDefaults : {}, this.dirDefaults = g, this.langDefaults = e, this.overrides = a, this.options = c([zb.defaults, g, e, a]), Ra(this.options), this.viewSpecCache = {}
        },
        ...
        buildViewSpecOptions: function (a) {
            a.options = c([zb.defaults, a.defaults, this.dirDefaults, this.langDefaults, this.overrides, a.overrides]), Ra(a.options)
        },
        buildViewSpecButtonText: function (a, b) {
            ...
            a.buttonTextOverride = c(this.overrides) || a.overrides.buttonText, a.buttonTextDefault = c(this.langDefaults) || c(this.dirDefaults) || a.defaults.buttonText || c(zb.defaults) || (a.duration ? this.humanizeDuration(a.duration) : null) || b
        },
